...
[
	...
	["Titan Anti-Personnel Missile", "Titan_AP", 400],        // Direct damage: low       | Splash damage: high   | Guidance: mouse, laser
	["Titan Anti-Air Missile", "Titan_AA", 450],              // Direct damage: low       | Splash damage: medium | Guidance: aircraft
...
[
	...
	["HBarrier Watchtower", "Land_HBarrierTower_F", 500, "object"],
	["Concrete Wall", "Land_CncWall1_F", 100, "object"],
	...
	["Canal Stairs", "Land_Canal_Wall_Stairs_F", 400, "object"],
...
[
	...
	["Tempest Ammo", "O_Truck_03_ammo_F", 2000, "vehicle"],
...
[
	...
	["Hunter HMG", "B_MRAP_01_hmg_F", 1500, "vehicle"],
	["Hunter GMG", "B_MRAP_01_gmg_F", 1750, "vehicle"],
	["Ifrit", "O_MRAP_02_F", 1100, "vehicle"],
	["Ifrit HMG", "O_MRAP_02_hmg_F", 1600, "vehicle"],
	["Ifrit GMG", "O_MRAP_02_gmg_F", 1850, "vehicle"],
	["Strider", "I_MRAP_03_F", 1200, "vehicle"],
	["Strider HMG", "I_MRAP_03_hmg_F", 1200, "vehicle"],
	["Strider GMG", "I_MRAP_03_gmg_F", 1950, "vehicle"],
	["MSE-3 Marid", "O_APC_Wheeled_02_rcws_F", 5000, "vehicle"],
	["AMV-7 Marshall", "B_APC_Wheeled_01_cannon_F", 6000, "vehicle"],
	["AFV-4 Gorgon", "I_APC_Wheeled_03_cannon_F", 7000, "vehicle"]
];

tanksArray = compileFinal str
[
	["CRV-6e Bobcat", "B_APC_Tracked_01_CRV_F", 9000, "vehicle"],
	["IFV-6c Panther", "B_APC_Tracked_01_rcws_F", 9250, "vehicle"],
	["FV-720 Mora", "I_APC_tracked_03_cannon_F", 8000, "vehicle"],
	["BTR-K Kamysh", "O_APC_Tracked_02_cannon_F", 8000, "vehicle"],
	["IFV-6a Cheetah AA", "B_APC_Tracked_01_AA_F", 10000, "vehicle"],
	["ZSU-39 Tigris AA", "O_APC_Tracked_02_AA_F", 10000, "vehicle"],
	["M2A1 Slammer", "B_MBT_01_cannon_F", 12000, "vehicle"],
	["M2A4 Slammer HMG", "B_MBT_01_TUSK_F", 12500, "vehicle"], // Commander gun variant
	["T-100 Varsuk", "O_MBT_02_cannon_F", 13000, "vehicle"],
	["MBT-52 Kuma", "I_MBT_03_cannon_F", 13500, "vehicle"]
];
...
[
	...
	["UH-80 Ghost Hawk (Black)", "B_Heli_Transport_01_F", 3100, "vehicle"], // UH-60 Stealth with 2 side miniguns
	["UH-80 Ghost Hawk (Green)", "B_Heli_Transport_01_camo_F", 3000, "vehicle"], // UH-60 Stealth with 2 side miniguns (green camo)
	["CH-67 Huron (Armed) [DLC]", "B_Heli_Transport_03_F", 3250, "vehicle"], // CH-47 with 2 side miniguns
	["AH-9 Pawnee", "B_Heli_Light_01_armed_F", 5500, "vehicle"], // Armed AH-6
	["PO-30 Orca (Armed, Black)", "O_Heli_Light_02_v2_F", 6000, "vehicle"], // Armed Ka-60 with orca paintjob
	["PO-30 Orca (Armed, Hex)", "O_Heli_Light_02_F", 6000, "vehicle"], // Armed Ka-60
	["WY-55 Hellcat (Armed)", "I_Heli_light_03_F", 8000, "vehicle"], // Armed AW159
	["AH-99 Blackfoot", "B_Heli_Attack_01_F", 12000, "vehicle"], // RAH-66 with gunner
	["Mi-48 Kajman (Hex)", "O_Heli_Attack_02_F", 13000, "vehicle"], // Mi-28 with gunner
	["Mi-48 Kajman (Black)", "O_Heli_Attack_02_black_F", 13000, "vehicle"] // Mi-28 with gunner (black camo)
];

planesArray = compileFinal str
[
	["A-143 Buzzard AA", "I_Plane_Fighter_03_AA_F", 15000, "vehicle"],
	["A-143 Buzzard CAS", "I_Plane_Fighter_03_CAS_F", 17500, "vehicle"],
	["A-164 Wipeout CAS", "B_Plane_CAS_01_F", 20000, "vehicle"],
	["To-199 Neophron CAS", "O_Plane_CAS_02_F", 20000, "vehicle"],
...
[
	...
	["Assault Boat (FIA)", "B_G_Boat_Transport_01_F", 250, "boat"],
	["Motorboat", "C_Boat_Civil_01_F", 350, "boat"],
	["Motorboat Rescue", "C_Boat_Civil_rescue_01_F", 400, "boat"],
	["Motorboat Police", "C_Boat_Civil_police_01_F", 400, "boat"],
